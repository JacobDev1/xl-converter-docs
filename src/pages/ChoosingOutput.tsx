export default function ChoosingOutput(){
    return(<>
        ...
        <h3>Custom</h3>
        <p>All images will be saved to that particular folder. If the folder doesn't exist, it will be created.</p>
        ...
        <p><b>Keep Folder Structure</b> - preserves folder hierarchy when saving images.</p>
        ...
        <ul>
            <li>Clear File List - the file list in the input tab will be cleared after conversion.</li>
