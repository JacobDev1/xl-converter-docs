...
export default function JPEGXLvsAVIF() {
    return(<>
        ...
        <p>Both JPEG XL and AVIF offer great image quality with different strengths.</p>
        ...
        <p>*Only 8193 x 4320 natively, larger sizes are achieved with tiling (which lowers efficiency beyond that point)</p>
        ...
        <p>AVIF is more stable in my experience.</p>
